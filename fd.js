...
const emailCheck = (email)=>{
  const clenaEmail = email.toString().trim()
  
  if(clenaEmail.includes('@')){
    return 'Email Verified'
  }else{
    return 'Must provide email'
  }
}
console.log(emailCheck('dsfadfsa@ '))
...
const chocolateFrogBuyer = (gold)=>{
  const totalChocolateBought = gold / 3
  return totalChocolateBought
}
const totalFrogs = chocolateFrogBuyer(8)
...
/*
  You might have noticed a slight bug in the previous problem. If you were to pass in 4 gold, the function would return to you 1.3333... However,
   you can't really go to a store and by 1.333 products. You would just be able to purchase 1 product. Re-write the function you used in the previous problem 
...
const chocolateFrogBuyer2 = (gold)=>{
  if(gold % 3 == 0){
    ...
    return 'Sorry your gold amout needs to be able to devide by 3'
  }
  
}
const totalFrogs2 = chocolateFrogBuyer2(10)
...
/*
  ...
  The function should return true, if it is sorted in ascending order, false if it is not. Create a variable, `arrayIsAscending` and set it equal to your 
...
const arrayIsAscending = arrTest(sampleArray)
